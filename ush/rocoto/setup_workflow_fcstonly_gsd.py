...
def get_workflow(dict_configs, cdump='gdas'):
    ...
    # getics
#JKH     deps = []
#JKH     data = '&ICSDIR;/@Y@m@d@H/&CDUMP;/pgbanl.&CDUMP;.@Y@m@d@H'
#JKH     dep_dict = {'type':'data', 'data':data}
#JKH     deps.append(rocoto.add_dependency(dep_dict))
#JKH     data = '&ICSDIR;/@Y@m@d@H/&CDUMP;/siganl.&CDUMP;.@Y@m@d@H'
#JKH     dep_dict = {'type':'data', 'data':data}
#JKH     deps.append(rocoto.add_dependency(dep_dict))
#JKH     data = '&ICSDIR;/@Y@m@d@H/&CDUMP;/sfcanl.&CDUMP;.@Y@m@d@H'
#JKH     dep_dict = {'type':'data', 'data':data}
#JKH     deps.append(rocoto.add_dependency(dep_dict))

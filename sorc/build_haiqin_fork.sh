...
# Default settings
APP="S2SWA"
CCPP_SUITES="FV3_GFS_v16,FV3_GFS_v16_no_nsst,FV3_GFS_v16_ugwpv1,FV3_GFS_v17_p8,FV3_GFS_v16_coupled_nsstNoahmpUGWPv1,FV3_GFS_v17_coupled_p8,FV3_GFS_v17_p8_mynn,FV3_GFS_v17_p8_c3"
...
source "${cwd}/ufs_model.fd_haiqin_fork/tests/detect_machine.sh"
source "${cwd}/ufs_model.fd_haiqin_fork/tests/module-setup.sh"
...
cd "${cwd}/ufs_model.fd_haiqin_fork"

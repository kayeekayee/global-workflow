...
# Default settings
APP="S2SWA"
CCPP_SUITES="FV3_GFS_v17_p8,FV3_GFS_v17_coupled_p8,FV3_GFS_v17_p8_mynn,FV3_GFS_v17_p8_thompson,FV3_GFS_v17_p8_c3"
...
source "${cwd}/ufs_model.fd_joe_fork/tests/detect_machine.sh"
source "${cwd}/ufs_model.fd_joe_fork/tests/module-setup.sh"

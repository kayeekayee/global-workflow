...
* regional hurricane models. There are 8 required    *
* input arguments.                                   *
*                                                    *
...
*  convention of fhr_n.ctl, where fhr = 000,024,etc  *
*  Designed to run using the inner-most nest grib    *
*  output from a given model.                        *                
*                                                    *
*  Default variable names are the same as standard   *
*  NCEP grb2 files. Edit Lines 52-69 if the variable *
*  names are different                               *
*                                                    *                                                   *
* Script developed by:                               * 
...
* run hfipNestGraphics.gs 012 1 Sandy_AL18 2012102900 HWRF EMC 367 709 
******************************************************
...
*** Compute and plot 200mb Temperature anomaly
    "set lev 200"
    "ambT=aave(temp,x=1,x="xSize",y=1,y="ySize")"
    "Tanom = temp - ambT"

    "set rgb 100 0 139 0"
    "set rgb 101 205 133 0"
    "set clevs  2 3 4 5 6 7 8"
    "set ccols 0 100 3 7 8 2 6 9"
...
*** Label the color bar
    "set strsiz 0.1 0.1"
    "set string 1 bl 1 0" ; "draw string 10.2 2.05 T Anom."
    "set string 1 bl 1 0" ; "draw string 10.22 1.85 (deg C)"
...
*** Label the color bar
    "set strsiz 0.1 0.1"
    "set string 1 bl 1 0" ; "draw string 10.15 1.8 Rel. Vort."
    "set string 1 bl 1 0" ; "draw string 10.05 1.6 (x10^-5/s)"
...
*** Plot the magnitude of the 10m winds
    ...
    "set rgb 60 0 74 255"
    "set rgb 30 0 230 255"
    "set rgb 55 0 255 0"
    "set rgb 70 255 255 0"
    "set rgb 75 255 135 0"
    "set rgb 110 247 0 255"
    "set rgb 160 128 0 255"

    "set clevs  20 34 64 83 96 114 137"
    "set ccols 0 60 30 55 70 75 110 160"
...
*** Label the color bar
    "set strsiz 0.1 0.1"
    "set string 1 bl 1 0" ; "draw string 10.1 2.04 Wind (kts)"
...
*** Label the RH color bar
    "set strsiz 0.08 0.08"
    "set string 1 bl 1 0" ; "draw string 10.3 0.78 RH (%)"
...
*** Compute and plot the temperature anomaly   
    "define tmean = ave(temp,x=1,x="xSize")"
    "set gxout contour"
    "set cthick 6"
...
*** Plot the T anomaly    
    "define tmean = ave(temp,y=1,y="ySize")"
    "set gxout contour"
    "set cthick 6"
    "set ccols 4 4 4 4 2 2 2 2"
    "set clevs -8 -6 -4 -2 2 4 6 8"

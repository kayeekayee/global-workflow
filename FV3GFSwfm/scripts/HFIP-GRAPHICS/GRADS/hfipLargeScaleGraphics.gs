...
* regional hurricane models. There are 7 required    *
* input arguments.                                  *
*                                                    *
...
* 7) Basin ID (l (lc L) for Atlantic or e for E.Pac) *
*                                                    *
...
*  NCEP grb2 files. Edit Lines 44-59 if the variable *
*  names are different                               *
*                                                    *
* Script developed by:                               * 
...
* run hfipLargeScaleGraphics.gs 012 1 Sandy_AL18 2012102900 HWRF EMC l 
******************************************************
...
*** Get the data grid geographical dimension
    ...
    startLon=subwrd(line,6); if(startLon>360.0); startLon=startLon-360.0; endif
...
*** Compute and plot 850mb relative vorticity
    ...
    "set rgb 100 0 139 0"
    "set rgb 101 205 133 0"
    "set clevs  4   6 8  10 12  14   16 18"
    "set ccols 0 100 3 10  7  12  101  8  2"
    "set csmooth on"
...
*** Save the image to file
    "printim "stormName"."date"."modelId".com_p.f"hour".png x"imgXSize" y"imgYSize
    "!mv "stormName"."date"."modelId".com_p.f"hour".png images"
...
*** Save the image to file
    "printim "stormName"."date"."modelId".200_p.f"hour".png x"imgXSize" y"imgYSize
    "!mv "stormName"."date"."modelId".200_p.f"hour".png images"
...
*** Save the image to file
    "printim "stormName"."date"."modelId".500_p.f"hour".png x"imgXSize" y"imgYSize
    "!mv "stormName"."date"."modelId".500_p.f"hour".png images"
...
*** Save the image to file
    "printim "stormName"."date"."modelId".850_p.f"hour".png x"imgXSize" y"imgYSize
    "!mv "stormName"."date"."modelId".850_p.f"hour".png images"
...
*** Save the image to file
    "printim "stormName"."date"."modelId".sfc_p.f"hour".png x"imgXSize" y"imgYSize
    "!mv "stormName"."date"."modelId".sfc_p.f"hour".png images"
...
*** Save the image to file
    "printim "stormName"."date"."modelId".700_p.f"hour".png x"imgXSize" y"imgYSize
    "!mv "stormName"."date"."modelId".700_p.f"hour".png images"
...
*** Save the image to file
    "printim "stormName"."date"."modelId".prc_p.f"hour".png x"imgXSize" y"imgYSize
    "!mv "stormName"."date"."modelId".prc_p.f"hour".png images"
